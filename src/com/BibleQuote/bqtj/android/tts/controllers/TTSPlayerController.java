...
package com.BibleQuote.bqtj.android.tts.controllers;

import android.content.Context;
import android.speech.tts.TextToSpeech;
import com.BibleQuote.bqtj.utils.Log;
import com.BibleQuote.bqtj.android.tts.exceptions.LanguageNotSupportedException;
import com.BibleQuote.bqtj.android.tts.exceptions.OnInitException;
...
public class TTSPlayerController implements TextToSpeech.OnInitListener, TextToSpeech.OnUtteranceCompletedListener {
	...
	public TTSPlayerController(Context context, Locale locale, ArrayList<String> textList) {
		this(context, locale);
		this.textList = textList;
	}
